    ...
    <div className="min-h-screen lg:grid lg:grid-cols-[16rem_1fr]">
      ...
      <aside className="hidden bg-ink-900 lg:flex lg:h-screen lg:flex-col lg:sticky lg:top-0">
        ...
        <div className="border-t border-ink-700 p-3">
          <p className="px-2 text-[10px] uppercase tracking-widest text-slate-500">Conectado como</p>
          <p className="truncate px-2 text-xs font-semibold text-slate-300">{user?.email}</p>
